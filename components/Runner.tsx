          ...
          <div className="bg-slate-800/50 backdrop-blur rounded-lg border border-slate-700 overflow-hidden">
            ...
            <div className="bg-slate-800 px-4 py-3 border-t border-slate-700">
              <button
                onClick={executeCode}
                disabled={isRunning}
                className="w-full bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 disabled:from-slate-600 disabled:to-slate-700 px-4 py-2.5 rounded-lg font-bold transition-all flex items-center justify-center gap-2 disabled:cursor-not-allowed"
              >
                <Play size={18} />
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-slate-800/30 backdrop-blur border border-slate-700 rounded-lg p-4">
            ...
            <p className="text-sm text-black dark:text-slate-300">
              <kbd className="bg-white dark:bg-slate-700 px-2 py-1 rounded text-xs">Tab</kbd> para indentar<br/>
              <kbd className="bg-white dark:bg-slate-700 px-2 py-1 rounded text-xs">Enter</kbd> auto-indenta
            </p>
          </div>
